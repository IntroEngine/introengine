...
- **Sincronización HubSpot**: Diario a las 12:00 PM UTC (`/api/cron/hubspot-sync`)

**Nota**: El plan Hobby de Vercel solo permite cronjobs diarios. Si necesitas mayor frecuencia, considera actualizar al plan Pro.
